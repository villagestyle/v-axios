...
class VAxios extends Axios {
  constructor(config) {
    super();
    __publicField(this, "requestQueue", /* @__PURE__ */ new Map());
    __publicField(this, "requestInterceptors", null);
    __publicField(this, "responseInterceptors", null);
    __publicField(this, "instance", null);
    __publicField(this, "defaultVConfig", { showLoading: false });
    (config == null ? void 0 : config.vConfig) && (this.defaultVConfig = config == null ? void 0 : config.vConfig);
  ...
  init() {
    this.instance.interceptors.request.use((config) => {
      if (this.requestInterceptors && this.verifyURL(config.url)) {
        ...
        if (extendsConfig)
          return this.requestInterceptors(extendsConfig);
    ...
    this.instance.interceptors.response.use(async (responseConfig) => {
      ...
      if (this.responseInterceptors && url) {
        ...
        return await this.responseInterceptors(__spreadProps(__spreadValues({}, responseConfig), {
          vConfig: extendsConfig == null ? void 0 : extendsConfig.vConfig,
  ...
  vGet(url, config) {
    return this.vRequest(__spreadValues({
      url,
      method: "get"
    }, config));
  }
  vPost(url, data, config) {
    return this.vRequest(__spreadValues({
      url,
      method: "post",
      data
